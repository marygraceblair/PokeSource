CREATE TABLE IF NOT EXISTS zz_pokemon (
  id                      INT,
  ...
  yield_sp_attack         INT,
  base_sp_defense         INT,
  yield_sp_defense        INT,
  base_speed              INT,
  yield_speed             INT,
  base_stats_total        INT,
  yield_stats_total       INT,
  generation_id           INT,
  introduced_in           INT,
  ...
  base_experience         INT,
  egg_cycles              INT,
  has_gender_traits       INT,
  growth_rate             INT,
  form_category           INT,
  is_permanent_form       INT,
  is_battle_form          INT,
  is_aesthetic_form       INT,
  is_default              INT,
  form_is_default         INT,
  species_order           INT,
  pokemon_order           INT,
...
INSERT INTO zz_pokemon SELECT
  p3.id as id, p3.id as pokemon_form_id, p1.id as pokemon_species_id, p2.id as pokemon_id, 1 as revision,
